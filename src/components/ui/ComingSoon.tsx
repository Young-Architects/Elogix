    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#f8f9ff] via-[#f1f3fe] to-[#eceef8]">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-6 pb-20 pt-32 text-center sm:pt-36 lg:px-8">
        ...
        <motion.p
          ...
          className="mb-4 text-[13px] font-bold uppercase tracking-[0.28em] text-violet-500"
        >
          {eyebrow}
        </motion.p>
        ...
        >
          ...
          <Link
            ...
            className={`inline-flex shrink-0 items-center justify-center gap-1.5 rounded-full border border-slate-200 bg-white/70 px-6 py-3.5 text-center font-semibold leading-tight text-slate-600 shadow-sm backdrop-blur-sm transition-colors hover:border-violet-300 hover:text-violet-600 ${CTA_TEXT} ${CTA_NOWRAP}`}
          >
